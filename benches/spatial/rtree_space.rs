...
use bevy_flock::spatial::{RTreeStorage, spatial_hash_system, SpatialPartition};
...
impl Benchmark {
    pub fn new(pos: Vec<Vec3>) -> Self {
        ...
        let mut partition = IntoSystem::into_system(spatial_hash_system::<RTreeStorage>);
